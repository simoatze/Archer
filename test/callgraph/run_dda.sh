...
$CLANG -DUSE_MPI=0 -I$HOME/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -emit-llvm -O0 -g -c $PROG_NAME -o $PROG_NAME.bc
$CLANG -DUSE_MPI=0 -I$HOME/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -emit-llvm -O0 -g -c foo.c -o foo.c.bc
# $LLVM_DIS -f foo.c.bc -o foo.c.ll
$CLANG -DUSE_MPI=0 -I$HOME/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -emit-llvm -O0 -g -c bar.c -o bar.c.bc
# $LLVM_DIS -f bar.c.bc -o bar.c.ll
$CLANG -DUSE_MPI=0 -I$HOME/usr/lib/gcc/x86_64-unknown-linux-gnu/4.9.1/include -emit-llvm -O0 -g -c bee.c -o bee.c.bc
