...
$OPT -load $PASS -$PASS_FLAG $PROG_NAME.bc -o $PROG_NAME-optimized.bc
$LLVM_DIS -f $PROG_NAME-optimized.bc -o $PROG_NAME-optimized.ll
$LLC $PROG_NAME-optimized.bc
$CLANG $PROG_NAME-optimized.s -O0 -o $PROG_NAME -L/g/g90/protze1/INSTALL/chaos_5_x86_64_ib/intel-omp/lib -liomp5
